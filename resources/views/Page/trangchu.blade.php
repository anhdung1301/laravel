                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price">
                                                    @if($new->promotion_price == 0)
                                                        <span class="lash-sale">{{$new->unit_price}}</span>
                                                    @else
                                ...
                                @foreach($sanpham_khuyenmai as $km)
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            ...
                                            @endif
                                            <div class="single-item-header">
                                                <a href="{{route('chitietsanpham',$km->id)}}"><img src="source/image/product/{{$km->image}}"
                                                                            alt=""></a>
                                            </div>
                                            <div class="single-item-body">
                                                <p class="single-item-title">{{$new->name}}</p>
                                                <p class="single-item-price">
                                                    @if($km->promotion_price == 0)
                                                        <span class="lash-sale">{{$km->unit_price}}</span>
                                                    @else
